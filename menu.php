      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="Ejercicio3V2.php">Ejercicio 3 Version 2.0</a></li>
            <li><a class="dropdown-item" href="Ejercicio4.php">Ejercicio 4</a></li>
            <li><a class="dropdown-item" href="Ejercicio4V2.php">Ejercicio 4 Version 2.0</a></li>
